...
from carsapp.models import CarsModel

# Create your views here.
def home(request):
    teams = Team.objects.all()
    featured_cars = CarsModel.objects.order_by('-created_date').filter(is_featured = True)
    ...
    body_style_search = CarsModel.objects.values_list('body_style', flat=True).distinct()
